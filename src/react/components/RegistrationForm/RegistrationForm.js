...
class RegistrationForm extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <CardBody>
          <CardTitle style={{"fontSize": "40px", "fontFamily": 'Poppins'}}>New User Registration</CardTitle>
        <Form >
           
           <Form.Row>
            <Form.Group as={Col} md="6" id="login-form" >
            <Form.Label  style={{ "fontSize": "25px", "fontFamily": 'Poppins'}} htmlFor="username">Username</Form.Label>
            ...
            <Form.Row>
          <Form.Group as={Col} md="6" id="login-form" >
          <Form.Label style={{"fontSize": "25px", "fontFamily": 'Poppins'}} htmlFor="picturelocation">Picture Location</Form.Label>
        ...
        <Form.Row>
          <Form.Group as={Col} md="6" id="login-form" onSubmit="">
            <Form.Label style={{"fontSize": "25px", "fontFamily": 'Poppins'}} htmlFor="password">Password</Form.Label>
            <Form.Control style={{"width": "250px"}} type="password" placeholder="Password" name="password" required onChange={this.handleChange}/>
          </Form.Group>

          <Form.Group as={Col} md="6" id="login-form" onSubmit="">
            <Form.Label style={{"fontSize": "25px", "fontFamily": 'Poppins'}} htmlFor="password">Repeat Password</Form.Label>
